...
export class FlyBlob implements Blob {
  ...
  slice(start?: number, end?: number, contentType?: string): FlyBlob {
    return new FlyBlob([this[bytesSymbol].slice(start, end)], {
...
function toUint8Arrays(
  ...
  for (const element of blobParts) {
    ...
    } else if (element instanceof FlyBlob) {
